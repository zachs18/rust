...
const ALLOWED_SOURCES: &[&str] = &[
    ...
    r#""git+https://github.com/zachs18/hashbrown?branch=more_unsized-0.16#fdbef1a289123090352429c1bbb71353fa3db2c7""#,
    r#""git+https://github.com/zachs18/hashbrown?branch=more_unsized-0.17#f46d8a1b185818e97e1aff9c232f3a3501ebec8e""#,
];
