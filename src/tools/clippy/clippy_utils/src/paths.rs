...
pub const INSERT_STR: [&str; 5] = ["alloc", "string", "string", "String", "insert_str"];
...
pub const PUSH_STR: [&str; 5] = ["alloc", "string", "string", "String", "push_str"];
...
pub const STRING_AS_MUT_STR: [&str; 5] = ["alloc", "string", "string", "String", "as_mut_str"];
pub const STRING_AS_STR: [&str; 5] = ["alloc", "string", "string", "String", "as_str"];
pub const STRING_NEW: [&str; 5] = ["alloc", "string", "string", "String", "new"];
