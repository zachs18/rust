...
impl<T: ?Sized> Rc<T> {
    ...
    /// Consumes and leaks the `Rc`, returning a shared reference,
    ...
    /// to call it as `Rc::leak(rc)` instead of `rc.leak()`. This
