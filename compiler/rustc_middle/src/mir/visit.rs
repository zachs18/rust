            ...
            fn super_source_scope_data(
                ...
                if let Some((callee, callsite_span)) = inlined {
                    ...
                    match callee_def {
                        ...
                        | ty::InstanceKind::PtrMetadataCmpShim(_def_id, ty)
                        | ty::InstanceKind::PtrMetadataDebugShim(_def_id, ty)
                        ...
                        ty::InstanceKind::PtrMetadataHashShim(_def_id, pointee_ty, hasher_ty) => {
                            ...
                            self.visit_ty($(& $mutability)? *hasher_ty, TyContext::Location(location));
                        }
                        ...
                        ty::InstanceKind::InitShim { method_def: _, method: _, self_ty, dst_ty, error_ty, arg_ty } => {
                            self.visit_ty($(& $mutability)? *self_ty, TyContext::Location(location));
                            self.visit_ty($(& $mutability)? *dst_ty, TyContext::Location(location));
