...
use crate::ty::{
    ...
    GenericArgs, GenericArgsRef, GenericParamDefKind, InitAdtComponentArg, InitAdtComponentInfo,
    InitAdtInfo, InitAdtInfoData, List, ListWithCachedTypeInfo, ParamConst, Pattern, PatternKind,
...
pub struct CtxtInterners<'tcx> {
    ...
    metadata_field_lists: InternedSet<
        'tcx,
...
impl<'tcx> CtxtInterners<'tcx> {
    fn new(arena: &'tcx WorkerLocal<Arena<'tcx>>) -> CtxtInterners<'tcx> {
        ...
        CtxtInterners {
            ...
            metadata_field_lists: InternedSet::with_capacity(N),
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn ty_dyn_metadata_struct(self, span: Span, dyn_type: Ty<'tcx>) -> Ty<'tcx> {
        let dyn_metadata_struct = self.require_lang_item(hir::LangItem::DynMetadata, span);
        self.type_of(dyn_metadata_struct).instantiate(self, &[dyn_type.into()]).skip_norm_wip()
    }
