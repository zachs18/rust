...
pub struct CtxtInterners<'tcx> {
    ...
    metadata_field_lists:
        InternedSet<'tcx, List<(rustc_span::Ident, ty::Visibility<DefId>, Ty<'tcx>)>>,
...
slice_interners!(
    ...
    metadata_field_lists: pub mk_metadata_field_list((rustc_span::Ident, ty::Visibility<DefId>, Ty<'tcx>)),
