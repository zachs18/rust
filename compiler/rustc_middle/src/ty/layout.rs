...
use crate::ty::{
    self, CoroutineArgsExt, SizedTraitKind, Ty, TyCtxt, TypeVisitableExt, Unnormalized,
};
            ...
            ty::Pat(base, pat) => {
                ...
                match *pat {
                    ...
                    ty::PatternKind::NotNull => match base? {
                        ...
                        SizeSkeleton::Pointer { non_zero: _, reduced } => {
                            Ok(SizeSkeleton::Pointer { non_zero: true, reduced })
                        }
                    },
                }
            }
