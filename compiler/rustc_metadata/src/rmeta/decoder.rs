...
impl CrateMetadata {
            ...
            ty::VariantDef::new(
                ...
                self.get_associated_item_or_field_def_ids(tcx, index)
                    .map(|did| ty::FieldDef {
                        ...
                        unsizability: self.get_field_unsizability(did.index),
                        pinned: self.get_field_pinnedness(did.index),
                    })
                    .collect(),
                parent_did,
                None,
    ...
    fn get_field_unsizability(&self, id: DefIndex) -> FieldUnsizability {
        self.root
            .tables
            .field_unsizability
            .get(self, id)
    ...
    fn get_field_pinnedness(&self, id: DefIndex) -> FieldPinnedness {
        self.root
            .tables
            .field_pinnedness
            .get(self, id)
