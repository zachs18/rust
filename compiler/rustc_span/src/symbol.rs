...
symbols! {
    ...
    Symbols {
        ...
        checked_offset_for_meta,
        checked_size_for_meta,
        client,
        clippy,
        clobber_abi,
        clone,
        ...
        debug_struct_finish,
        debug_struct_finish_non_exhaustive,
        debug_trait,
