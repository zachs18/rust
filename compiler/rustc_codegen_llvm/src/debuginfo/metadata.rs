            ...
            |cx, owner| {
                ...
                smallvec![
                    build_field_di_node(
                        ...
                        addr_field_name,
                        addr_field,
                        layout.fields.exact_offset(WIDE_PTR_ADDR),
                        DIFlags::FlagZero,
                    ...
                    build_field_di_node(
                        ...
                        extra_field_name,
                        extra_field,
                        layout.fields.exact_offset(WIDE_PTR_EXTRA),
                        DIFlags::FlagZero,
            ...
            fields
                ...
                .map(|(idx, (name, _span, _vis, _field_ty))| {
                    ...
                    build_field_di_node(
                        ...
                        name.as_str(),
                        field_ty,
                        layout.fields.exact_offset(idx),
                        DIFlags::FlagZero,
            ...
            variant_def
                ...
                .map(|(i, f)| {
                    ...
                    build_field_di_node(
                        ...
                        &field_name[..],
                        field_layout,
                        // FIXME(more_unsized): do something for fields past unsized fields
                        struct_type_and_layout.fields.offset(i).offset,
    ...
    up_var_tys
        ...
        .map(|(index, (up_var_ty, capture_name))| {
            build_field_di_node(
                ...
                layout.fields.exact_offset(index),
                DIFlags::FlagZero,
