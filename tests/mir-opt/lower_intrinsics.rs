...
pub fn make_pointers(a: *const u8, b: *mut (), n: usize) {
    ...
    let _thin_const: *const i32 = aggregate_raw_ptr(a, core::ptr::build_metadata!(for i32; ..));
    let _thin_mut: *mut u8 = aggregate_raw_ptr(b, core::ptr::build_metadata!(for u8; ..));
    let _slice_const: *const [u16] =
        aggregate_raw_ptr(a, core::ptr::build_metadata!(for [u16]; len: n, ..));
    let _slice_mut: *mut [u64] =
        aggregate_raw_ptr(b, core::ptr::build_metadata!(for [u64]; len: n, ..));
}
